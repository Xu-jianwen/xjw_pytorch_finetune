...
class ArcFace(ArcFaceLoss):
    def __init__(self, margin=28.6, scale=40, **kwargs):
        super(ArcFace, self).__init__(margin=margin, scale=scale, **kwargs)
    ...
    def compute_loss(self, W, embeddings, labels, indices_tuple=None):
        ...
        cosine = self.distance(embeddings, W)
